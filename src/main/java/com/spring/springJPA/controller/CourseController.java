...
public class CourseController {
    ...
    public ResponseEntity<?> addReview(@RequestBody Review review, @PathVariable("courseId") int courseId){
        try {
    ...
    public ResponseEntity<?> updateReview(@RequestPart Review review,@PathVariable("courseId") int courseId){
        try {
